        ...
        <div className="PSUEDOBODY TOPLEVEL h-auto  border border-transparent box-border overflow-visible pb-24  relative focus:outline-auto user-invalid:shadow-none disabled:cursor-default sm:pb-32 scroll-mt-64 ">
            ...
            >
                ...
                >
                    ...
                    >
                        If you or your loved one needs support engaging with
                        activities in the community we can provide solutions;
                        designing personalized care packages that will meet your
                        all needs.
                    </p>
                </div>
                <div
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    “Nema’s Outreach Support Service has been
                                    instrumental in helping my sister stay
                                    connected with her community. It’s more than
                    ...
                    >
                        <p
                            className={`border-0 border-solid border-zinc-300 box-border m-0 focus:outline-auto user-invalid:shadow-none disabled:cursor-default`}
                        >
                            Nema Home Care’s Outreach Support Service is a
                            specialized offering designed to extend our care
                            beyond the confines of the home. This service is
                            built on the principles of community, connection,
                            and empowerment, providing support in various
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <strong
                                        className={`border-0 border-solid border-zinc-300 box-border text-[rgb(17,24,39)] font-semibold focus:outline-auto user-invalid:shadow-none disabled:cursor-default`}
                                    >
                                        Experience Community Support with Nema
                                        Home Care
                                    </strong>{" "}
                                    {"..."}
                                    At Nema Home Care, we understand that care
                                    extends beyond the home. Our Outreach
                                    Support Service is designed to provide
                                    assistance and support in various aspects of
                                    daily life, from attending appointments to
                                    participating in community activities. Our
                                    team of dedicated professionals is committed
                                    to helping you stay connected and engaged
                                    with your community.
                                </span>
                            </li>
                            <li
                            ...
                            >
                                ...
                                >
                                    ...
                                    shopping, transportation to appointments, or
                                    support in attending social events, our
                                    Outreach Support Service is here to help.
                                    We’re not just caregivers; we’re partners in
                                    making your daily life easier and more
                                    enjoyable.
                                </span>
                            </li>
                            <li
                            ...
                            >
                                ...
                                >
                                    ...
                                    Our Outreach Support Service is more than
                                    just a helping hand; it’s a commitment to
                                    keeping you connected and engaged with your
                                    community. We believe that everyone deserves
                                    to lead a fulfilling life, and our service
                                    is designed to empower you to do just that.
                                </span>
                            </li>
                        </ul>
                        <p
                        ...
                        >
                            With Nema Home Care’s Outreach Support Service,
                            ...
                            empowers you to stay connected with your community.
                        </p>
                        <h2
                        ...
                        >
                            If you’re unsure whether our Outreach Support
