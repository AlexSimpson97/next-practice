...
export default function ActiveSectionContextProvider({
    ...
    const [timeOfLastClick, setTimeOfLastClick] = useState(0); // we need to keep track of this to disable the observer temporarily (1 min) when user clicks on a link
